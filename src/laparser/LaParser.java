...
public class LaParser extends Parser {
	...
	public final Chamada_atribuicaoContext chamada_atribuicao() throws RecognitionException {
		...
		try {
			...
			case 13:
				...
				setState(339); argumentos_opcional();
			...
			case 51:
				enterOuterAlt(_localctx, 2);
				{
				setState(342); outros_ident();
				setState(343); dimensao();
				setState(344); match(20);
	...
	public final SelecaoContext selecao() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(354); constantes();
			setState(355); match(50);
			setState(356); comandos();
			setState(357); mais_selecao();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final ConstantesContext constantes() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(362); numero_intervalo();
			setState(363); mais_constantes();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Numero_intervaloContext numero_intervalo() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(369); op_unario();
			setState(370); match(NUM_INT);
			setState(371); intervalo_opcional();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final FatorContext fator() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(398); parcela();
			setState(399); outras_parcelas();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Outros_fatoresContext outros_fatores() throws RecognitionException {
		...
		try {
			...
			if (_la==35 || _la==43) {
				{
				setState(401); op_multiplicacao();
				setState(402); fator();
				setState(403); outros_fatores();
				}
			}
	...
	public final ParcelaContext parcela() throws RecognitionException {
		...
		try {
			...
			case CADEIA:
				enterOuterAlt(_localctx, 2);
				{
				setState(410); parcela_nao_unario();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final Parcela_unarioContext parcela_unario() throws RecognitionException {
		...
		try {
			...
			case 2:
				...
				setState(419); outros_ident();
				setState(420); dimensao();
				}
				break;
			...
			case 3:
				...
				setState(425); mais_expressao();
				setState(426); match(56);
				}
				break;
			...
			case 6:
				enterOuterAlt(_localctx, 6);
				{
				setState(430); match(13);
				setState(431); expressao();
	...
	public final Parcela_nao_unarioContext parcela_nao_unario() throws RecognitionException {
		...
		try {
			...
			case 42:
				enterOuterAlt(_localctx, 1);
				{
				setState(436); match(42);
				setState(437); match(IDENT);
	...
	public final Outras_parcelasContext outras_parcelas() throws RecognitionException {
		...
		try {
			...
			if (_la==55) {
				...
				setState(445); parcela();
				setState(446); outras_parcelas();
				}
			}
